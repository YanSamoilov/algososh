...
export const changingStateActiveBubble = (arr: Array<numsProps>, active: number, status: ElementStates, callback: Function) => {
...
export const chacngeStateAfterLoopBubble = (arr: Array<numsProps>, end: number, callback: Function) => {
...
export const changingStateActiveChoice = (arr: Array<numsProps>, active: number, callback: Function) => {
...
export const chacngeStateAfterLoopChoice = (arr: Array<numsProps>, start: number, callback: Function) => {
...
export const forChangingStateChoice = (arr: Array<numsProps>, forChange: number, callback: Function, previous?: number, start?: number) => {
